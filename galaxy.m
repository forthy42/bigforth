...
how:
  : open     new DF[ iterate self ]DF s" Galaxy" open-component ;
  : dialog   new DF[ iterate self ]DF s" Galaxy" open-dialog ;
  : open-app new DF[ iterate self ]DF s" Galaxy" open-application ;
class;
...
public:
 ...
 ( [varstart] )  ( [varend] ) 
how:
  : open     new DF[ ok-button self ]DF s" About" open-component ;
  : dialog   new DF[ ok-button self ]DF s" About" open-dialog ;
  : open-app new DF[ ok-button self ]DF s" About" open-application ;
class;
...
public:
 ...
 ( [varstart] )  ( [varend] ) 
how:
  : open     new DF[ 0 ]DF s" Measure" open-component ;
  : dialog   new DF[ 0 ]DF s" Measure" open-dialog ;
  : open-app new DF[ 0 ]DF s" Measure" open-application ;
class;
...
endwith ]S ( MINOS ) S" None" menu-entry new 
        ^^ S[ ^ galaxy with
    1 disc# ! redraw-galaxy s" New/Old" meas-string assign
endwith ]S ( MINOS ) S" New/Old" menu-entry new 
        ^^ S[ ^ galaxy with
    2 disc# ! redraw-galaxy s" Old" meas-string assign
endwith ]S ( MINOS ) S" Old" menu-entry new 
        ^^ S[ ^ galaxy with
    3 disc# ! redraw-galaxy s" New" meas-string assign
endwith ]S ( MINOS ) S" New" menu-entry new 
 ...
 ( [methodstart] )  ( [methodend] ) 
  : widget  ( [dumpstart] )
        ...
        &8 vabox new
          ...
          ^^ S[ close ]S ( MINOS ) S" OK" button new  ^^bind ok-button
...
redraw-galaxy ]SC ( MINOS )  TT" Background intensity" hscaler new 
                ...
                &3 habox new
                    ...
                    &2 vabox new
                  &2 habox new
                        ^^ -1 T[ spiral-dist on make-galaxy ][ ( MINOS ) spiral-dist off make-galaxy ]T ( MINOS ) S" dist" tbutton new 
                        ^^ -1 T[ dirsens on a# draw redraw-galaxy ][ ( MINOS ) dirsens off a# draw redraw-galaxy ]T ( MINOS )  TT" On: Show a only in direction to center" S" ->r" tbutton new 
                        M: measure-menu widget S" " info-menu new  ^^bind meas-string
                      ...
                      $0 $1 *hfil $0 $1 *vfil glue new 
                        ^^ &3 &7 SC[ $100 swap << to star# make-galaxy ]SC ( MINOS )  TT" 2^(9+n) stars" hscaler new 
                          $0 $1 *hfil $0 $1 *vfil glue new 
                          ^^ SN[  ]SN ( MINOS ) &10. ]N ( MINOS ) textfield new  ^^bind iterations
                          $0 $1 *hfil $0 $1 *vfil glue new 
...
fsel-action ]S ( MINOS )  icon" icons/save" icon-but new 
              ...
              ^^ S[ iterate-disc ]S ( MINOS ) S" Disc" button new  ^^bind iterates
              ^^ S[ close ]S ( MINOS ) S" Close" button new 
              ^^ S[ about open ]S ( MINOS ) S" About" button new 
